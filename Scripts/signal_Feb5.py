...
def Noise(flow,delta_f,delta_t):
	...
	return pycbc.noise.noise_from_psd(t_samples, delta_t, psd, seed=127)
...
# Choosing Scalar-Tensor Theory
b = ST_to_ppE(m1,m2,chi1,chi2)[0]
beta = ST_to_ppE(m1, m2, chi1, chi2)[1]

delta_t = 1.0/4096.0
tp = IFFT_to_TD(b,beta,sp,sc,delta_t)[0]
tc = IFFT_to_TD(b,beta,sp,sc,delta_t)[1]
