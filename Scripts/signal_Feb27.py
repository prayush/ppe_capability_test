...
delta_f = sp.delta_f
delta_t = 1.0/4096.0
tp, tc = IFFT_to_TD(m1,m2,b,beta,freq_sp,freq_sc,sp_array,sc_array,delta_t,delta_f)

flow = 30.0
noise = np.array(Noise(flow,delta_f,delta_t))

tp, tc = Array_Match(tp,tc,noise)
